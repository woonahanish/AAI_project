...
class LinkedList{
    ...
    int search(Node* h, string variable){
        ...
        while(temp->conditions1 != variable){
...
/*
    void define_conclusionList(int instantiate, int srl, string clause1, string clause2, string clause3, string clause4){

        Node_Clause_var_List *newNode = new Node_Clause_var_List(instantiate, srl, clause1, clause2, clause3, clause4);
        if(head == NULL){
            head = newNode;
            return;
        }
...
*/    
    ...
    LinkedList_Var l_v;
    l_v.variable_name("PROBLEM", 1);// variable_response[0]);
